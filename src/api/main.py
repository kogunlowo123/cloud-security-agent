"""Cloud Security Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Cloud security posture agent that scans multi-cloud environments for misconfigurations, enforces security baselines, monitors for policy violations, and auto-remediates common security issues.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
