"""Cloud Security Agent - Domain-Specific Connectors."""
...
class SiemConnectorConnector:
    """Domain-specific connector for siem connector integration with Cloud Security Agent."""
...
class EdrConnectorConnector:
    """Domain-specific connector for edr connector integration with Cloud Security Agent."""
...
class ThreatIntelConnector:
    """Domain-specific connector for threat intel integration with Cloud Security Agent."""
...
class TicketingSystemConnector:
    """Domain-specific connector for ticketing system integration with Cloud Security Agent."""
